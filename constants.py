...
RAG_NUMBER_OF_CHUNK = 500
RAG_OVERLAP_SIZE = int(RAG_NUMBER_OF_CHUNK * 0.1)
RAG_NUMBER_OF_DOCS = 20
...
SYSTEM_PROMPT_INQUIRY = """
    ...
    [c1]文脈とユーザー入力の関連性を100点満点で評価し、90点以下の関連性の低い文脈を排除します。
    [c2]その後、関連性の高い文脈をもとに、以下の条件に基づき、ユーザー入力に対して回答してください。
